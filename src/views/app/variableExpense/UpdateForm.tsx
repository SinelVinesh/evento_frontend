...
import {getVariableExpense, updateVariableExpense} from "services/Api";
import {VariableExpense} from "../../../common/appTypes";
...
const ConfiguredForm: React.FC = () => {
  ...
  const apiInitialCall = getVariableExpense;
  const apiSubmitCall = updateVariableExpense;
