  ...
  const properties: FieldProperties[] = [
    ...
    },
    {
      ...
      validators: [
        ...
        {
          validationType: ValidationType.dateAfter,
          args: {date: data.startDate},
          feedback: "La date de fin doit être supérieur à la date de début"
        }
      ],
    },
    {
      ...
      multiple: {
        bodyTop: <h4>Dépenses tarifées</h4>,
